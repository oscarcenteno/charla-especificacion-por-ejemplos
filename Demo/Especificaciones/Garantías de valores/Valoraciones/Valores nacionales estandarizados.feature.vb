...
Namespace Especificaciones.GarantiasDeValores.Valoraciones
...
#End ExternalSource
        ...
        Public Overridable Sub TestInitialize()
            If ((Not (TechTalk.SpecFlow.FeatureContext.Current) Is Nothing)  _
                ...
                Especificaciones.GarantiasDeValores.Valoraciones.CalcularAporteDeGarantiasFeature.FeatureSetup(Nothing)
            End If
        End Sub
